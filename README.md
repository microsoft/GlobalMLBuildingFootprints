...
## Updates
* 2024-12-02 - Added **12M** building footprint edits and **554k** height estimates derived from Maxar and Vexcel imagery between 2918 and 2024. The largest contributionsare to Sudan (5.5M), Ethiopia (3.3M), and Saudi Arabia (590k). dataset-links.csv updated on 2 December 2024. Changed 
merge logic to update tiles at LOD 19 instead of LOD 15 reducing update boundary visibility.
